...
class Footer extends Component{
    render(){
        return (
            ...
            <a target="_blank" rel="noopener noreferrer" href="https://github.com/LillianWakefield" title="" className="github">
            <FontAwesomeIcon icon={faGithub}/></a><a target="_blank" rel="noopener noreferrer" href="https://theoffseasoner.wordpress.com/" title="" className="wordpress"><FontAwesomeIcon icon={faWordpress}/></a>
