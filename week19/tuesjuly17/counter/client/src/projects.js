            ...
            <h2 className="heading"> Recent Projects</h2>
                  ...
                  <Row>
                    ...
                    <Column className="col-lg-6">
                        ...
                        <p><a target="_blank" rel="noopener noreferrer"  href="https://lillianwakefield.github.io/Pic-a-Pup/index.html">Live Demo</a> | <a target="_blank" href="https://github.com/LillianWakefield/Pic-a-Pup">GitHub</a></p>
                    </Column>
                  </Row>
                  <Row>
                    <Column className="col-lg-6 box">
                    ...
                    <Column className="col-lg-6">
                        ...
                        <p><a target="_blank">Live Demo</a> | <a target="_blank"  rel="noopener noreferrer" href="https://github.com/LillianWakefield/language-game">GitHub</a></p>
                    </Column>
                  </Row>
                </div>
